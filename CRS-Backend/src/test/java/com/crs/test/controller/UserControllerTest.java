...
public class UserControllerTest {
	...
	void setUp() {
		...
		this.user.setFirstName("Chaitanya");
		this.user.setLastName("Talware");
		this.user.setEmail("2020bcs008@gmail.com");
		this.user.setPassword("2020bcs008@gmail.com");
		this.user.setPhone("123456874");
		this.user.setPinCode(431605);
